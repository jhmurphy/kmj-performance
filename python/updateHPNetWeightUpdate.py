...
CSV_TO_READ = 'NetWeightUpdate.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE Imaster SET NetWeight = ? FROM Imaster WHERE PLCID = ? AND PartNumber = ? ",Weight,PLCID, PartNumber)
