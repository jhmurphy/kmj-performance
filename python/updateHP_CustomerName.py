...
CSV_TO_READ = 'NameChange.csv'  # This assumes your part numbers are in the first column
...
#Open CSV file
csv_Amazon = csv.reader(open(CSV_TO_READ, encoding="utf8"), delimiter=CSV_TO_READ_DEL)
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE Customer SET Name = ? WHERE AccountNumber = ?", Name, AccountNumber)
